...
var CityStats_1 = __webpack_require__(32);
preact_1.render(preact_1.h("div", { class: "container" },
    preact_1.h(CityStats_1.default, { nombre: "Santiago,CL" }),
    preact_1.h(CityStats_1.default, { nombre: "Auckland,NZ" }),
    preact_1.h(CityStats_1.default, { nombre: "Zurich,SW" }),
    preact_1.h(CityStats_1.default, { nombre: "Sydney,AU" }),
    preact_1.h(CityStats_1.default, { nombre: "London,UK" }),
    preact_1.h(CityStats_1.default, { nombre: "Georgia,USA" })), document.querySelector("#app"));
...
var CityStats = (function (_super) {
    ...
    CityStats.prototype.btnClick = function (props) {
        var _this = this;
        axios_1.default.get(url + "/api/redis/getLatLng/" + this.props.nombre).then(function (res) {
            console.log("getStats OK nombre=" + _this.props.nombre + " lat=" + res.data.lat + " lng=" + res.data.lng);
            axios_1.default.get(url + '/api/forecast/getTimeTemp/' + res.data.lat + "/" + res.data.lng)
                .then(function (resForecast) {
                console.log('/forecast.IO ... OK', resForecast.data);
                _this.setState({
                    hour: util_1.default.getHourTimezone(resForecast.data.time, resForecast.data.offset),
                    temp: resForecast.data.temp,
                    summ: resForecast.data.summ,
                    icon: util_1.default.getIconUrlForecastIO(resForecast.data.icon)
                });
    ...
    CityStats.prototype.render = function (props) {
        var nombre = this.props.nombre;
        var _a = this.state, hour = _a.hour, temp = _a.temp, icon = _a.icon, summ = _a.summ;
        return (preact_1.h("button", { class: "btnForecast btn btn-primary", type: "button", onClick: this.btnClick },
            preact_1.h("div", { class: "icon" },
                icon !== "" && preact_1.h("img", { src: icon, alt: summ, width: "60" }),
                preact_1.h("span", null, nombre)),
            preact_1.h("div", { class: "badge1" },
                preact_1.h("span", { class: "badge" },
                    preact_1.h("span", { class: "glyphicon glyphicon-time", "aria-hidden": "true" }),
                    " ",
                    hour),
                " \u00A0",
                preact_1.h("span", { class: "badge" },
                    preact_1.h("span", { class: "glyphicon glyphicon-dashboard", "aria-hidden": "true" }),
                    " ",
                    temp,
                    "\u00B0"))));
    };
...
exports.default = {
    ...
    getHourTimezone: function (tiempoInt, offset) {
        var date = new Date(tiempoInt + offset * 3600 * 1000).toUTCString().replace(/ GMT$/, "");
        var dateHora = date.substring(date.indexOf(':') - 2); // Extrae solo la hora
